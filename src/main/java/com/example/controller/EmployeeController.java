...
import com.example.exception.FieldShouldNotEmptyException;
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> createEmployee(@Valid @RequestBody Employee employee){
		if(employee.getSalary()<=0.0){
			throw new FieldShouldNotEmptyException("Provide value for salary");
		}
...
//		Employee employee2=employeeService.getEmployeeById(employee.getEmpId());
